...
# @patch("app.routers.approvals.send_approval_notification")
# def test_create_approval(mock_send, client):
...
# @patch("app.routers.approvals.send_approval_notification")
# def test_get_pending_approvals(mock_send, client):
#     mock_send.return_value = {
#         "channel": "C123456",
#         "ts": "1234567890.123456",
#     }
...
# @patch("app.routers.approvals.send_approval_notification")
# def test_approve_approval(mock_send, client):
#     mock_send.return_value = {
#         "channel": "C123456",
#         "ts": "1234567890.123456",
#     }
...
# @patch("app.routers.approvals.send_approval_notification")
# def test_reject_approval(mock_send, client):
#     mock_send.return_value = {
#         "channel": "C123456",
#         "ts": "1234567890.123456",
#     }
